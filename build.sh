...
if [[ $build_netf -eq 1 ]]; then
    sed -i 's|<ItemGroup>|<ItemGroup Condition="'\''$(TargetFramework)'\'' == '\''net7.0'\''"><!--hacks-->|' $plugin_name/$plugin_name.csproj
fi
...
## hacks to allow building netf
if [[ $build_netf -eq 1 ]]; then
    sed -i 's|<ItemGroup Condition="'\''$(TargetFramework)'\'' == '\''net7.0'\''"><!--hacks-->|<ItemGroup Condition="'\''$(TargetFramework)'\'' == '\''net48'\''"><!--hacks-->|' $plugin_name/$plugin_name.csproj
fi
