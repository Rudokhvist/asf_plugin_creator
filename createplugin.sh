...
echo -e "\n## Dotnet new classlib"
dotnet new classlib -f net7.0 -n $plugin_name
...
## replace of 'net7.0' with 'net7.0;net481' & 'TargetFramework' with 'TargetFrameworks'.
...
#sed -i 's|net7.0|net7.0;net481|' $plugin_name/$plugin_name.csproj
